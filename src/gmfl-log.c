...
log_level_str (GLogLevelFlags log_level)
{
  switch (((gulong)log_level & G_LOG_LEVEL_MASK))
    ...
    case GMFL_LOG_LEVEL_TRACE: return "   \033[1;36mTRACE\033[0m";
...
static void
gmfl_log_handler (const gchar    *domain,
  ...
  if (g_once_init_enter (&initialized))
    {
      ...
      g_log_set_default_handler (gmfl_log_handler, NULL);
